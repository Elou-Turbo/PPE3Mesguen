...
--
-- Hôte : 127.0.0.1:3307
-- Généré le :  ven. 27 sep. 2019 à 08:30
...
INSERT INTO `etape` (`TRNNUM`, `ETPID`, `LIEUID`, `ETPHREMIN`, `ETPHREMAX`, `ETPHREDEBUT`, `ETPHREFIN`, `ETPNBPALLIV`, `ETPNBPALLIVEUR`, `ETPNBPALVARCHARG`, `ETPNBPALVARCHARGEUR`, `ETPCHEQUE`, `ETPETATLIV`, `ETPCOMMENTAIRE`, `ETPVAL`, `ETPKM`) VALUES
(1, 1, 1, NULL, NULL, '2019-09-14 00:00:00', '2019-09-15 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL),
(1, 2, 19, NULL, NULL, '2019-09-28 00:00:00', '2019-09-29 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL),
(6, 1, 7, NULL, NULL, '2019-09-27 00:00:00', '2019-09-28 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL);
...
--
CREATE TABLE `test` (
`ConcatenatedString` varchar(165)
);
...
(4, 'AO454DL', '0', '123', NULL, '2019-09-13 09:55:00'),
(5, 'CY497RV', '29', '', NULL, '2019-09-20 09:46:00'),
(6, 'AO454DL', '0', '', NULL, '2019-09-27 08:15:00');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `test`  AS  select concat(`bdd_mesguen`.`chauffeur`.`CHFID`,';',`bdd_mesguen`.`chauffeur`.`CHFNOM`,';',`bdd_mesguen`.`chauffeur`.`CHFPRENOM`,';',`bdd_mesguen`.`chauffeur`.`CHFTEL`,';',`bdd_mesguen`.`chauffeur`.`CHFMAIL`,';') AS `ConcatenatedString` from `bdd_mesguen`.`chauffeur` ;
...
--
ALTER TABLE `lieu`
  MODIFY `LIEUID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT pour la table `tournee`
--
ALTER TABLE `tournee`
  MODIFY `TRNNUM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
